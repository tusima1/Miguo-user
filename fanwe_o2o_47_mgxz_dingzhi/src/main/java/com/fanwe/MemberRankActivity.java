...
public class MemberRankActivity extends BaseActivity
{
	...
	private void initPullToRefreshListView()
	{
		...
		mPull_toRefresh.setOnRefreshListener(new OnRefreshListener2<ScrollView>()
		{
	...
	protected void bindData(Uc_HomeModel actModel)
	{
		...
		SDViewBinder.setTextView(mTv_address, AppRuntimeWorker.getCity_name(), "未找到");
		SDViewBinder.setImageView(mIv_avatar, actModel.getUser_avatar());
		SDViewBinder.setTextView(mTv_number, actModel.getDist().getAllow()+"个","0个");
