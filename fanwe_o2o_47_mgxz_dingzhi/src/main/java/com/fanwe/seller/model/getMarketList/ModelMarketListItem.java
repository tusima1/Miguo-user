 ...
 */
public class ModelMarketListItem {
    ...
    public void setBank_union(String bank_union) {
        this.bank_union = bank_union;
    }

    public String getBank_union() {
        return this.bank_union;
    }
    ...
    public void setBuss_license(String buss_license) {
        this.buss_license = buss_license;
    }

    public String getBuss_license() {
        return this.buss_license;
    }
