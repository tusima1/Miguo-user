 ...
 */
public class ModelShopListItem {
    ...
    public void setCons_money(String cons_money) {
        this.cons_money = cons_money;
    }

    public String getCons_money() {
        return this.cons_money;
    }
    ...
    public void setDiscount_pay(String discount_pay) {
