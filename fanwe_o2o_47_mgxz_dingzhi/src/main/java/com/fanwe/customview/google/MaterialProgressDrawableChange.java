...
public class MaterialProgressDrawableChange extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawableChange(Context context, View animExcutor) {
