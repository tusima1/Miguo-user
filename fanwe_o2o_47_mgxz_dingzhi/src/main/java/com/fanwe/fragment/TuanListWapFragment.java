...
public class TuanListWapFragment extends BaseFragment
{
	...
	protected void init()
	{
		...
		String url;
		if (ServerUrl.DEBUG) {
			url = ServerUrl.SERVER_API_URL_PRE + ServerUrl.SERVER_API_TEST_URL + ServerUrl.URL_PART_WAP;
		}else{
			url = ServerUrl.SERVER_API_URL_PRE + ServerUrl.SERVER_API_URL_MID + ServerUrl.URL_PART_WAP;
		}
