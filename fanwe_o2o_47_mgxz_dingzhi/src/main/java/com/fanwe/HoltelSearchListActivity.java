...
public class HoltelSearchListActivity extends BaseActivity
{
	...
	private ArrayList<CategoryOrderModel> price;
	private ArrayList<CategoryOrderModel> recommend;
	private ArrayList<CategoryOrderModel> sale;
	...
	{	
		...
		price = new ArrayList<CategoryOrderModel>();
		CategoryOrderModel categoryOrderModel_price1 = new CategoryOrderModel();
		categoryOrderModel_price1.setName("低价优先");
		price.add(categoryOrderModel_price1);
		CategoryOrderModel categoryOrderModel_price2 =new CategoryOrderModel();
		categoryOrderModel_price2.setName("高价优先");
		price.add(categoryOrderModel_price2);
		
		recommend = new ArrayList<CategoryOrderModel>();
		CategoryOrderModel categoryOrderModel_recommend1 =new CategoryOrderModel();
		categoryOrderModel_recommend1.setName("推荐排序");
		recommend.add(categoryOrderModel_recommend1);
		CategoryOrderModel categoryOrderModel_recommend2 =new CategoryOrderModel();
		categoryOrderModel_recommend2.setName("好评优先");
		recommend.add(categoryOrderModel_recommend2);
		
		sale = new ArrayList<CategoryOrderModel>();
		CategoryOrderModel categoryOrderModel_sale1 =new CategoryOrderModel();
