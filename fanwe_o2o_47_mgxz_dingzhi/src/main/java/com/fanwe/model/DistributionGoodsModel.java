...
public class DistributionGoodsModel
{
	...
	public String toString() {
		return "DistributionGoodsModel [id=" + id + ", name=" + name
				+ ", sub_name=" + sub_name + ", icon=" + icon + ", icon_157="
				+ icon_157 + ", icon_85=" + icon_85 + ", current_price="
				+ current_price + ", origin_price=" + origin_price
				+ ", sale_count=" + sale_count + ", sale_total=" + sale_total
				+ ", sale_balance=" + sale_balance + ", fx_salary=" + fx_salary
				+ ", fx_salary_type=" + fx_salary_type + ", fx_salary_money="
				+ fx_salary_money + ", url=" + url + ", share_url=" + share_url
				+ ", ud_is_effect=" + ud_is_effect + ", ud_type=" + ud_type
				+ ", end_status=" + end_status + ", sale_balanceFormat="
				+ sale_balanceFormat + ", sale_totalFormat=" + sale_totalFormat
				+ ", current_priceFormat=" + current_priceFormat
				+ ", origin_priceFormat=" + origin_priceFormat
				+ ", fx_salary_moneyFormat=" + fx_salary_moneyFormat
				+ ", end_statusFormat=" + end_statusFormat + ", cancelText="
				+ cancelText + ", cancelTextColor=" + cancelTextColor
				+ ", cancelBackground=" + cancelBackground + ", shareText="
				+ shareText + ", shareTextColor=" + shareTextColor
