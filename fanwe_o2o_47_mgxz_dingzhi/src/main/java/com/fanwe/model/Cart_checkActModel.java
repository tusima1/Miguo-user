...
public class Cart_checkActModel extends BaseActModel
{
	...
	private float red_packet_total;
	private Red_Packet_info red_packet_info;
	// add
	...
	public float getRed_packet_total() {
		return red_packet_total;
	}

	public void setRed_packet_total(float red_packet_total) {
		this.red_packet_total = red_packet_total;
	}

	public Red_Packet_info getRed_packet_info() {
		return red_packet_info;
	}

	public void setRed_packet_info(Red_Packet_info red_packet_info) {
