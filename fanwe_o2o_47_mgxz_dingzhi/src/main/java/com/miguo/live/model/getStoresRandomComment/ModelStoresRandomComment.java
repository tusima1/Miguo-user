 ...
 */
public class ModelStoresRandomComment {
    ...
    public void setImages_cache(String images_cache) {
        this.images_cache = images_cache;
    }
    ...
    public void setReply_supplier_account_id(String reply_supplier_account_id) {
        this.reply_supplier_account_id = reply_supplier_account_id;
    }
