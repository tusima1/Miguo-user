...
public class UserRedPacketInfo {
    ...
    public String red_packets_create_date;
    public String red_packet_id;
    public String red_packet_name;
    public String red_packet_amount;
    public String is_used;
    public String use_area_restrictions;
    public String use_store_restrictions;
    public String event_start;
    public String event_end;
    public String available_time_start;
    public String user_id;
    public String amount_limit;
    public String deduction_limit;
    public String is_preferential_overlay;
    public String available_period_data;
    public String available_period;
    public String id;
    public String spokesman_id;
    public String order_sn;
    public String only_one;
