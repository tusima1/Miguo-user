 ...
 */
public class TimeLimitedHorizontalScrollView extends BaseHorizantalScrollView implements RoundImageView.RoundImageViewOnTouchListener{
    ...
    public TimeLimitedHorizontalScrollView(Context context) {
        super(context);
        init();
    }

    public TimeLimitedHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TimeLimitedHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                Log.d(tag, " action move");
    ...
    public void setHomeTuanTimeLimitView(HomeTimeLimitView homeTuanTimeLimitView) {
