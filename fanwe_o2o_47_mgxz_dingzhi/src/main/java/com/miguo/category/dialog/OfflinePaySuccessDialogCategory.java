...
import com.miguo.listener.dialog.OfflinePaySuccessDialogListener;

/**
 * Created by Barry/狗蛋哥/zlh on 2017/2/20.
 */

public class OfflinePaySuccessDialogCategory extends DialogFragmentCategory {
    ...
    public OfflinePaySuccessDialogCategory(View view, HiBaseDialog fragment) {
        super(view, fragment);
    }
    ...
    protected void initFragmentListener() {
        listener = new OfflinePaySuccessDialogListener(this);
    }
    ...
    @Override
    public OfflinePaySuccessDialog getDialog() {
        return (OfflinePaySuccessDialog)super.getDialog();
    }
}
