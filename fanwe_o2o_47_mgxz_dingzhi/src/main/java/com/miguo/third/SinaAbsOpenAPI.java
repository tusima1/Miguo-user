 ...
 * @since 2013-11-05
 */
public abstract class SinaAbsOpenAPI {
    private static final String TAG = SinaAbsOpenAPI.class.getName();
     ...
     */
    public SinaAbsOpenAPI(Context context, String appKey, Oauth2AccessToken accessToken) {
        mContext = context;
        mAppKey = appKey;
