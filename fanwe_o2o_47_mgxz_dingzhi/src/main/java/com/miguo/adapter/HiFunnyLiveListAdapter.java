...
public class HiFunnyLiveListAdapter extends BarryBaseRecyclerAdapter{

    public HiFunnyLiveListAdapter(Activity activity, List datas) {
    ...
    public class MainActivityHomeFragmentLiveListAdapterListener extends BarryListener {
        ...
        @Override
        public HiFunnyLiveListAdapter getAdapter() {
            return (HiFunnyLiveListAdapter) super.getAdapter();
        }
    }
}
