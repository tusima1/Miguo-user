...
public class SDBaseActivity extends FragmentActivity implements SDEventObserver, OnClickListener
{
	...
	public void setmListenerLifeCircle(SDBaseActivityLifeCircleListener mListenerLifeCircle)
	{
		this.mListenerLifeCircle = mListenerLifeCircle;
	}

	public void setmListenerOnActivityResult(SDBaseActivityOnActivityResultListener mListenerOnActivityResult)
	{
