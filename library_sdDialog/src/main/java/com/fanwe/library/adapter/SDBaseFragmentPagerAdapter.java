...
public abstract class SDBaseFragmentPagerAdapter<T> extends FragmentPagerAdapter
{
	...
	public SDBaseFragmentPagerAdapter(List<T> listModel, Activity activity, FragmentManager fm)
	{
		super(fm);
		setData(listModel);
